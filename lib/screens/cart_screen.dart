...
class _CartScreenState extends State<CartScreen> {
  ...
  void initState() {
    super.initState();
    getDevice();
    _codeTrans = generateRandomString(7);
    print('code trans :' + _codeTrans);
    initPlatformState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final shopData = Provider.of<LogInOut>(context, listen: false);
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      if ((await printer.isConnected)!) {
                        ...
                        printer.printCustom(shopData.shopName, 3, 1);
                        printer.printNewLine();
                        printer.printCustom(shopData.addressShop, 1, 1);
                        printer.printNewLine();
                        printer.printNewLine();
                        printer.printLeftRight('Kode Transaksi', _codeTrans, 1);
